...
def condition(st):
    ...
    [insideStatement, restStatement] = insideBrackets(restStatement.strip(), TList["blstart"], TList["blend"])
...
def loop(st):
    ...
    [ifStatement, restStatement] = insideBrackets(restStatement.strip(), TList["blstart"], TList["blend"])
